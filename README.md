...
SSO Microsoft → demande → validation → VM OpenStack (Infomaniak) automatique → arrêt à l'échéance.
Le tout sur **Cloudflare Workers**.

[![CI](https://github.com/Thomas-TP/GIT-VM-OpenStack/actions/workflows/ci.yml/badge.svg)](https://github.com/Thomas-TP/GIT-VM-OpenStack/actions/workflows/ci.yml)
...
- 🐧 **7 systèmes** : Ubuntu 24.04 & 22.04, Debian 12 & 13, Rocky Linux 9,
  **Windows Server 2022** et **Windows poste de travail** (Server 2025, bureau).
...
`SESSION_SECRET`, `ENTRA_CLIENT_SECRET`, `OS_PASSWORD`, `EMAILJS_PRIVATE_KEY`.
Détail, credentials OpenStack, rotation : [`docs/CONFIGURATION.md`](docs/CONFIGURATION.md).
