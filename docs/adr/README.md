...
| # | Décision | Statut |
|---|---|---|
| [0001](0001-garder-aws-et-cloudflare-workers.md) | Garder AWS EC2 + Cloudflare Workers (vs pivot Infomaniak/OpenTofu) | ⤴︎ Superseté par [0010] (compute) |
| [0002](0002-provisioning-api-directe-vs-terraform.md) | Provisioning par API OpenStack directe + module Terraform documenté | ✅ Acté |
...
| [0009](0009-snapshots-et-restauration-locale.md) | Snapshots (image Glance) + restauration à la création | ✅ Acté |
| [0010](0010-migration-openstack.md) | Migration du backend compute AWS EC2 → **OpenStack** (Infomaniak) | ✅ Acté |
