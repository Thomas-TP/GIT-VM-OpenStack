...
- L'auto-**stop** ramène le coût compute à ≈ 0 (seul le volume reste facturé) tout en **préservant les
...
- (−) Le stockage (volume) des VM expirées continue d'être facturé (faible) → prévoir une purge manuelle/règle.
